...
function Navbar() {
    ...
    return (
        <nav className='flex items-center justify-between flex-wrap bg-cyan-200 p-6'>
            <div className='flex items-center flex-shrink-0 text-cyan-900 mr-6'>
                <Link to='/' className='font-semibold text-xl tracking-tight'>Library</Link>
            </div>
            <div className="block">
                <button 
                    onClick={dropDown} 
                    className="flex items-center px-3 py-2 text-cyan-900 
